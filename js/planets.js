...
const planetsData = [
    {
        ...
        imageUrl: 'https://github.com/Supertik-h/Planet_info/blob/main/assets/mercury.png'
    },
    {
        name: "Venus",
    ...
    },
    {
        ...
        climate: "Cold (-63°C)",
        description: "Red planet with the potential for future colonization",
    ...
    },
    {
        ...
        description: "Tilted on its side with a rotation different from other planets",
...
//idk what this does: replit says Create HTML for planet information display
...
// Initialize the the dropdown objects and 
function initializePlanets() {
    populatePlanetDropdown();
    
    const dropdown = document.getElementById('planet-dropdown');
    //checks to see if dropdown has a value 
    if (dropdown) {
        //addeventlistener gets input drom the dropdown 
        dropdown.addEventListener('change', (e) => {
            //updates the webview with the info. e.target.value gets the user input from the dropdown and passes it as a parameter
            updatePlanetInfo(e.target.value);
        });
    }
}

// idk - replit says Start when page loads
